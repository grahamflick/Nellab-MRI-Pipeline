...
3) Add the participant to the "MRI_Participant_INFO" document located at /MEG2/MRI_Data.

4) Add the MRI number and sharing info under "MRI Information" to the NELLAB-AD Participants Sheet.
